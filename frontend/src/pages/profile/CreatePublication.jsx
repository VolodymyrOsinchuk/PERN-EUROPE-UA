...
//   try {
//     await customFetch.post("/publications", payload);
...
//       <Typography variant="h5" sx={{ mb: 2 }}>Створити публікацію</Typography>
//       <Form method="post">
//         <TextField name="title" label="Заголовок" fullWidth sx={{ mb: 2 }} />
//         <TextField name="date" label="Дата" type="date" InputLabelProps={{ shrink: true }} fullWidth sx={{ mb: 2 }} />
//         <TextField name="content" label="Текст" multiline rows={6} fullWidth sx={{ mb: 2 }} />
...
export async function action({ request }) {
  ...
  try {
    ...
    toast.error(
      error?.response?.data?.message || "Помилка створення публікації",
    );
    return null;
  }
}
...
export default function CreatePublication() {
  ...
  const steps = [
    { label: "Заголовок", done: step1Done },
    { label: "Текст", done: step2Done },
  ];
    ...
    <Box sx={{ bgcolor: "#f8fafc", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          >
            Поділіться корисним досвідом та знаннями зі спільнотою
          </Typography>
        </Box>
      </Box>
            ...
            >
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
                <TextField
                  ...
                  required
                  fullWidth
                  placeholder="Наприклад: Як отримати NIP в Польщі за 3 кроки"
                  value={articleTitle}
                ...
                <Box sx={{ display: "flex", gap: 2 }}>
                  ...
                  <TextField
                    ...
                    helperText="Необов'язково (наприклад: 8 хв)"
