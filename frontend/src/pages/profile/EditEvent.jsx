...
//   if (!event) return <Container><Typography>Подію не знайдено</Typography></Container>;

//   return (
//     <Container maxWidth="sm">
//       <Typography variant="h5" sx={{ mb: 2 }}>Редагувати подію</Typography>
//       <Form method="post">
//         <TextField name="title" label="Назва" defaultValue={event.title} fullWidth sx={{ mb: 2 }} />
//         <TextField name="date" label="Дата" type="date" defaultValue={event.date ? event.date.split('T')[0] : ''} InputLabelProps={{ shrink: true }} fullWidth sx={{ mb: 2 }} />
//         <TextField name="location" label="Місце" defaultValue={event.location} fullWidth sx={{ mb: 2 }} />
//         <TextField name="description" label="Опис" multiline rows={4} defaultValue={event.description} fullWidth sx={{ mb: 2 }} />
//         <Box sx={{ display: "flex", gap: 1 }}>
//           <Button type="submit" variant="contained">Зберегти</Button>
//           <Button href="/profile/events">Скасувати</Button>
//         </Box>
//       </Form>
//     </Container>
//   );
...
export async function action({ request, params }) {
  ...
  try {
    ...
    toast.error(error?.response?.data?.message || "Помилка оновлення події");
    return null;
  }
}
...
export default function EditEvent() {
  ...
  const step1Done = !!(title && description);
  const step2Done = !!(date && location);
    ...
    <Box sx={{ bgcolor: "#f8fafc", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          >
            Оновіть інформацію про вашу подію
          </Typography>
        </Box>
      </Box>
        ...
        <Form method="post">
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            >
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
                ...
                <TextField
                  ...
                  inputProps={{ minLength: 10, maxLength: 3000 }}
                  helperText="Від 10 до 3 000 символів"
                  sx={inputSx}
                />
              </Box>
            </StepSection>
            ...
            <StepSection
              number={2}
              title="Дата та місце"
              subtitle="Коли і де відбудеться подія"
              completed={step2Done}
            >
              <Box
                sx={{
